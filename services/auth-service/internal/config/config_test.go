...
func TestLoad(t *testing.T) {
	...
	if cfg.ListenAddr != "127.0.0.1:44442" || cfg.DatabaseURL != "postgres://auth@localhost/platform" || cfg.SessionIdleTimeout != 15*time.Minute || cfg.SessionAbsoluteTimeout != 8*time.Hour || cfg.PasswordResetTTL != 20*time.Minute || cfg.CookieSecure {
