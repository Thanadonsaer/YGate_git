...
PLATFORM_MIDDLEWARE_PATCH_DIR=C:\YGate\data\middleware-patches
PLATFORM_SITE_LOGO_DIR=C:\YGate\data\site-logos
PLATFORM_PLANT_IMAGE_DIR=C:\YGate\data\plant-images
