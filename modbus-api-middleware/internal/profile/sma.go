...
func SMADeviceSet(brandID int64) domain.DeviceSet {
	return domain.DeviceSet{
		...
		Addresses: []domain.Address{
			...
			smaAddress(30769, 2, "I32", "DC current input (Ipv)", "dc_current_input", .001, "A", "A", ""),
			smaAddress(30771, 2, "I32", "DC voltage input (Vpv)", "dc_voltage_input", .01, "V", "V", ""),
			smaAddress(30773, 2, "I32", "DC power input (Ppv)", "input_power", 1, "W", "kW", ""),
			smaAddress(30775, 2, "I32", "AC active power (Pac)", "active_power", 1, "W", "kW", ""),
			...
			smaAddress(30805, 2, "I32", "Reactive power (Qac)", "reactive_power", .01, "var", "kvar", ""),
			smaAddress(30813, 2, "I32", "Apparent power (Sac)", "apparent_power", 1, "VA", "kVA", ""),
			...
			smaAddress(34109, 2, "I32", "Heat sink temperature", "temperature", .1, "C", "C", ""),
			smaAddress(34113, 2, "I32", "Interior temperature 1", "interior_temperature", .1, "C", "C", ""),
		},
	}
}
