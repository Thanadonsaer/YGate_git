...
func (s *Server) templateCSV(w http.ResponseWriter, r *http.Request) {
	...
	_ = cw.Write([]string{"ABB", "Inverter", "PVS100", "VENDOR_RAW", "03", "40084", "Watts", "active_power", "0.01", "I16", "kW", "kW", "true", "Address.xlsx State=use"})
	_ = cw.Write([]string{"ABB", "Inverter", "PVS100", "VENDOR_RAW", "03", "40108", "Operating State", "inverter_state", "1", "U16", "", "", "true", "Address.xlsx State=use"})
	_ = cw.Write([]string{"ABB", "Inverter", "PVS100", "VENDOR_RAW", "03", "40233", "%Command Watt Limit", "active_power_adjustment", "0.1", "U16", "%", "%", "true", "Readback value; Modbus write control is separate"})
	_ = cw.Write([]string{"ABB", "Inverter", "PVS50", "VENDOR_RAW", "03", "40084", "Watts", "active_power", "0.01", "I16", "kW", "kW", "true", "Address.xlsx State=use"})
	_ = cw.Write([]string{"ABB", "Inverter", "PVS50", "VENDOR_RAW", "03", "40108", "Operating State", "inverter_state", "1", "U16", "", "", "true", "Address.xlsx State=use"})
	_ = cw.Write([]string{"ABB", "Inverter", "PVS50", "VENDOR_RAW", "03", "40233", "%Command Watt Limit", "active_power_adjustment", "0.1", "U16", "%", "%", "true", "Readback value; Modbus write control is separate"})
	_ = cw.Write([]string{"Huawei", "Inverter", "SUN2000", "VENDOR_RAW", "03", "32080", "Active power", "active_power", "0.001", "I32", "kW", "kW", "true", "Per Huawei Modbus Interface Definitions register 32080"})
	_ = cw.Write([]string{"Huawei", "Inverter", "SUN2000", "VENDOR_RAW", "03", "32089", "Device status", "inverter_state", "1", "U16", "", "", "true", "Use unsigned so 0xA000 remains 40960"})
	_ = cw.Write([]string{"Huawei", "Inverter", "SUN2000", "VENDOR_RAW", "03", "32114", "Energy yield of current day", "day_cap", "0.01", "U32", "kWh", "kWh", "true", "Per Huawei Modbus Interface Definitions register 32114"})
	_ = cw.Write([]string{"Huawei", "Inverter", "SUN2000", "VENDOR_RAW", "03", "35302", "Power_adjustment", "active_power_adjustment", "0.1", "I16", "%", "%", "true", "Readback value; Modbus write control is separate"})
	cw.Flush()
