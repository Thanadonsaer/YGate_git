...
export const navigation = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/register-metadata", label: "Device Models", icon: Settings2, requires: "device_model:read" },
...
export const titles: Record<string, string> = {
  ...
  "/register-metadata": "Device Models",
  "/scada": "SCADA Builder",
  "/scada/live": "SCADA",
...
export const pagePermissionGroups: PagePermissionGroup[] = [
  ...
  { href: "/register-metadata", label: "Device Models", entries: [{ resourceType: "device_model" }] },
